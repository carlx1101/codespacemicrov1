          ...
          <div class="flex-grow-1 mx-auto" style="max-width: 28rem;">
            ...
            <form class="js-validate needs-validation" novalidate method="POST" action="{{ route('login') }}">
              ...
              <div class="mb-4">
                ...
                <input type="email" class="form-control form-control-lg" id="signupModalFormLoginEmail" placeholder="email@site.com" aria-label="email@site.com" name="email" :value="old('email')" required autofocus autocomplete="username">
              ...
              <!-- Google Button -->
            <div class="d-grid mb-3">
                <a class="btn btn-white btn-lg" href="{{ route('google.redirect') }}" style="width: 100%;">
