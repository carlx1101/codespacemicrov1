          ...
          <div class="mb-2 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search courses" aria-label="Search course">
              </div>
              <!-- End Search -->
            </form>
          </div>
          ...
          <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
            ...
            <thead class="thead-light">
              <tr>
                ...
                <th class="table-column-ps-0">Course Name</th>
                <th>Category</th>
                <th>Sub Category</th>
                <th>Status</th>
                <th>Completion</th>
                  ...
                  <a class="d-flex align-items-center" href="/user-profile.html">
                    ...
                    <div class="avatar ">
                      @foreach (json_decode($course->photo_path) as $path)
                        <img class="avatar-img" src="{{ asset('storage/'. $path) }}"/>
                       @endforeach
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">{{$course->title}}</span>
                    </div>
                  </a>
                </td>
                <td>
                  <span class="d-block h5 mb-0">{{$course->category}}</span>
                </td>
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="productsEditDropdown1">
                       ...
                       <a class="dropdown-item" href="{{ route('sections.index', ['courseId' => $course->id]) }}">
                        <i class="bi-archive dropdown-item-icon"></i> Curriculum
                    </a> 
                      ...
                      <form action="{{ route('courses.updateStatus', $course->id) }}" method="POST">
                          ...
                          <button type="submit" class="dropdown-item">
                              ...
                              @else
                                  <i class="bi-x-lg dropdown-item-icon"></i> Publish
                              @endif
                          </button>
                        </form> 
